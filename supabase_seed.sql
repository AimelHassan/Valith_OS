...
-- Reflects actual Valith OS Seed Brief data as of 2026-06-03
...
-- 7. Insert Leads
-- To match application rules: early-stage leads (non-SOW, non-Negotiation, non-Closed) have setup and retainer estimates stored in the database but will be visually/commercially constrained in the UI.
-- Note: Foreign lead values (Hil Hamer) are converted from USD to PKR using a conservative 1 USD = 280 PKR rate.
INSERT INTO leads (
...
('d0000000-0000-0000-0000-000000000006', 'b0000000-0000-0000-0000-000000000006', 'c0000000-0000-0000-0000-000000000007', 'Protribes RFP Intelligence', 'LinkedIn', 'A2 RFP Active', 'RFP Intelligence', 'Replied', 'Waiting', 'Medium', 25, 225000, 45000, 'No more message today. If no reply in 24 to 48 hours, follow up on LinkedIn.', '2026-06-05', NULL, 'Fast CEO reply, requested details.', 'Info@ can bury email.', 'Details email sent. LinkedIn anchor sent.'),
